...
/----------------------------------------------------------------------*/
CLine:: CLine() : loc(0,0,0), dir (1,0,0), color(0,0,0), level(0), t(-1e6), obj(NULL), dentro(false) {
}
...
/*-<==>-----------------------------------------------------------------
 / Gets the state of the line, true if it is inside an object
 /----------------------------------------------------------------------*/
bool CLine::getDentro(){
	return dentro;
}